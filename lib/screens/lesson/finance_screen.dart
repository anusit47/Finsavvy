...
class _FinanceScreenState extends State<FinanceScreen> {
  ...
  final List<FinanceCard> pages = const [
    FinanceCard(
      ...
      content:
          '   มันคือทักษะที่จำเป็นสำหรับทุกคน ไม่ว่าคุณจะมีรายได้มากหรือน้อย หรืออยู่ในช่วงวัยใดก็ตาม การเรียนรู้เรื่องการเงินเปรียบเสมือนการลงทุนที่ให้ผลตอบแทนคุ้มค่าที่สุด เพราะความรู้ทางการเงินเป็นสิ่งที่สามารถนำไปใช้ประโยชน์ได้ตลอดชีวิต ไม่ว่ายุคสมัยจะเปลี่ยนแปลงไปอย่างไร หลักการทางการเงินก็ยังคงเป็นจริงเสมอ',
      imagePath: 'assets/images/all-finsavvy-image/dsfawfaw.png',
    ),
    FinanceCard(
      title: 'ชีวิตของเราผูกพันกับเงินอย่างหลีกเลี่ยงไม่ได้',
      content:
          '   ไม่ว่าจะเป็นการใช้จ่ายประจำวัน การออมเงิน การลงทุน หรือการวางแผนเพื่ออนาคต การจัดการเงินที่ดีจะช่วยให้เรามีความมั่นคงทางการเงิน สามารถใช้ชีวิตได้อย่างมีความสุข และบรรลุเป้าหมายในชีวิตได้อย่างราบรื่น การจัดการทางการเงินที่ดีประกอบด้วย 3 องค์ประกอบหลัก ได้แก่',
